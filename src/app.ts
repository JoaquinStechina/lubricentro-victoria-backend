...
// Arma la app sin escucharla. Separado de server.ts a propósito: los tests de
// integración importan `app` y la levantan en un puerto efímero, cosa que no
// se podía hacer cuando este archivo llamaba a listen() al importarse.
