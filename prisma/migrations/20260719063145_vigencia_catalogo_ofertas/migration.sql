...
INSERT INTO "new_ofertas" ("archivoOrigen", "cargaId", "createdAt", "descripcion", "descuentoPct", "desdeCantidad", "fechaOferta", "horaOferta", "id", "marca", "moneda", "numeroOferta", "precioUnitario", "proveedorId", "rawData", "skuProveedor") SELECT "archivoOrigen", "cargaId", "createdAt", "descripcion", "descuentoPct", "desdeCantidad", "fechaOferta", "horaOferta", "id", "marca", "moneda", "numeroOferta", "precioUnitario", "proveedorId", "rawData", "skuProveedor" FROM "ofertas";
DROP TABLE "ofertas";
...
INSERT INTO "new_productos_precios" ("alicuotaIva", "cargaId", "createdAt", "descripcion", "fechaVigencia", "id", "marca", "moneda", "precioConIva", "precioNeto", "proveedorId", "rawData", "seccion", "skuInterno", "skuProveedor", "unidad") SELECT "alicuotaIva", "cargaId", "createdAt", "descripcion", "fechaVigencia", "id", "marca", "moneda", "precioConIva", "precioNeto", "proveedorId", "rawData", "seccion", "skuInterno", "skuProveedor", "unidad" FROM "productos_precios";
